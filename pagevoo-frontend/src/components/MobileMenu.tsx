                  ...
                  <a
                    ...
                    style={{
                      ...
                      ...(buttonStyling && buttonStyling.enabled ? {
                        ...
                        marginTop: `${buttonStyling.marginTop || 5}px`,
                        marginRight: `${buttonStyling.marginRight || 5}px`,
                        marginBottom: `${buttonStyling.marginBottom || 5}px`,
                        marginLeft: `${buttonStyling.marginLeft || 5}px`,
                        textDecoration: 'none',
