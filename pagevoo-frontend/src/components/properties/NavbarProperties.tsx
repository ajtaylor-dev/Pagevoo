  ...
  return (
    <>
                        ...
                        <div className="mb-4 border-t border-gray-600 pt-4">
                          ...
                          {selectedSection.content?.buttonStyling?.enabled && (
                            <button
                              ...
                              className="w-full px-3 py-2 bg-purple-900 hover:bg-purple-800 border border-purple-700 rounded text-purple-200 text-xs font-medium transition flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="mb-4 border-t border-gray-600 pt-4">
                          ...
                          <pre className="bg-gray-700 border border-gray-600 rounded p-3 text-xs overflow-auto max-h-64 font-mono text-gray-200">
{(() => {
