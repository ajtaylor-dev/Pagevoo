...
use Core\Router; use Controllers\AuthController; use Controllers\AdminController; use Controllers\SiteController; $router = new Router();
...
$router->get('/api/auth/2fa-setup', [AuthController::class, 'twofaSetup']);
$router->get('/api/sites/mine', [\Controllers\SiteController::class, 'mine']);
